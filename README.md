...
- name: download-tools
  ...
  args:
    - >-
      ...
      https://github.com/IBM/argocd-vault-plugin/releases/download/v1.1.2/argocd-vault-plugin_1.1.2_linux_amd64 &&
      chmod +x argocd-vault-plugin &&
...
RUN curl -L -o argocd-vault-plugin https://github.com/IBM/argocd-vault-plugin/releases/download/v1.1.2/argocd-vault-plugin_1.1.2_linux_amd64
