...
| AVP_OP_CONNECT_TOKEN       | 1Password Connect access token                      | Required with `TYPE` of `1passwordconnect`                                                                                                                                   |
| AVP_OP_CONNECT_HOST        | 1Password Connect hostname                          | Required with `TYPE` of `1passwordconnect`                                                                                                                                   |
